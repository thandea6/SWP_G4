...
document.addEventListener("click", function(event) {
        ...
        <div class="mx-auto mt-10">
            <div class="flex">
                ...
                <div class="w-full bg-white p-6 rounded shadow ml-6">
                        ...
                        <div class="btn-wrapper">
                            <form action="orderManagement" method="post" class="search-form">
    ...
    <button onclick="toggleDropdown()" class="btn">
        Trạng Thái Đơn Hàng <i class="fas fa-caret-down"></i>
    </button>
    <div id="dropdownMenu" class="hidden absolute mt-2 w-48 bg-white border rounded shadow-lg">
        <a href="orderPending" class="dropdown-item">Đơn Hàng Đang Chờ</a>
        <a href="orderProcessing" class="dropdown-item">Đơn Hàng Đang Xử Lý</a>
        <a href="orderDone" class="dropdown-item">Đơn Hàng Đã Hoàn thành</a>
        <a href="orderCancel" class="dropdown-item">Đơn Hàng Đã Hủy</a>
    </div>
</div>
                            </div>
