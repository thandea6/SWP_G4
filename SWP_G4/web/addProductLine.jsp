    ...
    <body class="bg-gray-100">
        <div class="container mx-auto mt-10">
            <div class="menu">
                ...
                <div class="content" style="background-color: lightgoldenrodyellow">
                    <h1 class="text-2xl font-bold mb-6">Thêm Dòng Sản Phẩm</h1>
                    <p style="color: orange" id="message">${mess}</p>
                <form action="addProductLine" method="post">
