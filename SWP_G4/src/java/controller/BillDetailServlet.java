...
//            Shop shop = listS.get(0);
            ...
            listO = sp.getBillDetail(shopId, orderId);
            request.setAttribute("listO", listO);
            int totalAll = 0;
            for (ProductLine quantity : listO) {
                totalAll = totalAll + quantity.getTotal();
            }
...
//            request.setAttribute("shop", shop);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user == null) {
            ...
            od.nextStatus(orderId, shopId);
            int statusId = od.getStatusByOrder(orderId, shopId);
            //get lai thong tin
            ShopProductDAO sp = new ShopProductDAO();
            ...
            request.setAttribute("orderId", orderId);
            request.setAttribute("totalAll", totalAll);
            request.setAttribute("mess", "Update Status Successful");
