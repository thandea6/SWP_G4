 ...
 * @author VIET HOANG
 */
@WebServlet(name = "SearchHomeServlet", urlPatterns = {"/searchHome"})
public class SearchHomeServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SearchHomeServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SearchHomeServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (a == null) {
            ...
            list = spd.searchProduct(key, cIdList, bIdList, minValue, maxValue);
            ...
            list = spd.searchProductbyWishList(key, cIdList, bIdList, minValue, maxValue, u.getUserId());
